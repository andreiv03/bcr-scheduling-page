...
mapboxgl.accessToken =
  "pk.eyJ1IjoiYW5kcmVpdjAzIiwiYSI6ImNsYmk3aWczMTB3emQzbnJybWZyMmZnNzQifQ.VyYVW-L-y_RRXxJ2-1B26A";
...
const UnitMarker = (
  ...
  >
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M10 0C15.5204 0 20 4.53388 20 10.1211C20 14.6105 16.536 19.9965 11.8375 25.1785C10.8482 26.2736 9.15183 26.2736 8.16403 25.1801C3.46397 19.9965 0 14.6105 0 10.1211C0 4.53388 4.47964 0 10 0Z"
      fill="#376AE2"
    />
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      d="M8.49466 5.57015C8.49466 6.00342 8.64267 6.37369 8.93811 6.68073C9.22848 6.98927 9.58568 7.14377 10.0003 7.14377C10.4069 7.14377 10.766 6.98927 11.0626 6.68073C11.3586 6.37369 11.5066 6.00342 11.5066 5.57015C11.5066 5.14635 11.3554 4.77158 11.0588 4.46396C10.7628 4.15508 10.4069 4 10.0003 4C9.58568 4 9.22848 4.15819 8.93371 4.46846C8.64267 4.7755 8.49466 5.14635 8.49466 5.57015ZM15 9.27077V10.2256H7.41426V10.7701H15V14.3648C15 15.2672 14.2837 16 13.4001 16H6.59927C5.71564 16 5 15.2672 5 14.3648V13.4111H12.5863V12.866H5V9.27077C5 8.36858 5.71564 7.63485 6.59927 7.63485H13.4001C14.2837 7.63485 15 8.36858 15 9.27077Z"
      fill="white"
    />
  </svg>
);
...
const Mapbox: React.FC<{
  ...
  isMapVisible: [_isMapVisible, setIsMapVisible],
  unitsByGeolocation,
  incrementStep,
  onChangeUnit,
}) => {
  ...
  const [lat, _setLat] = useState("44.4410307");
  const [lng, _setLng] = useState("26.0516768");
  ...
  useEffect(() => {
    ...
    unitsByGeolocation.forEach((unit) => {
      ...
      const marker = new mapboxgl.Marker({
        ...
        .setLngLat([
          parseFloat(unit.location.longitude),
          parseFloat(unit.location.latitude),
        ])
        .addTo(map.current);
  ...
  return (
    <>
      ...
      <div
        className={`${styles["current_unit"]} ${
          Object.keys(currentUnit).length ? styles["visible"] : ""
        }`}
      >
        <button
          onClick={() => {
            onChangeUnit(currentUnit), incrementStep();
          }}
        >
          Alege unitatea
        </button>
        ...
        <div className={styles["content"]}>
          ...
          <div className={styles["bottom_section"]}>
            ...
            {currentUnit.appointmentsSchedule?.isCashless && (
              <h4>Fără casiere</h4>
            )}
          </div>
        </div>
